        ...
        <div class="fixed inset-0 bg-[#030303] text-white p-6 md:p-12 blueprint-grid overflow-y-auto z-[100]">
            <div class="max-w-7xl mx-auto">
                <div class="w-full border-b border-electric/20 pb-4 mb-12 flex justify-between items-end font-mono">
                    <div class="text-[10px] text-electric animate-pulse uppercase">● CHANNEL: EMERGENCY_DISPATCH_ACTIVE</div>
                    <button onclick="window.closeBentoPage()" class="btn-industrial py-2 px-6">Logout_Dispatch</button>
                </div>

                <header class="mb-16">
                    <span class="text-[10px] text-electric font-bold tracking-[0.3em] uppercase italic">Public Safety / Dispatch</span>
                    <h1 class="heading-font text-6xl md:text-8xl font-black uppercase tracking-tighter mt-2 italic">Emergency <span class="text-electric">Services</span></h1>
                </header>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div class="lg:col-span-5 cyber-panel-crim p-10 border-t-2 border-t-red-600">
